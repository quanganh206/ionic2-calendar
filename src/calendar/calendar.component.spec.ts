import {
  ...
  describe('TickTockComponent', () => {
    ...
    let componentFixture: ComponentFixture<CalendarComponent>;
    let componentInstance: CalendarComponent;
    ...
    beforeEach(() => {
      componentFixture = TestBed.createComponent(CalendarComponent);
    ...
    it('should display time string', (done) => {
      ...
      setInterval(() => {
        ...
        const tickTockPageElement = componentFixture.debugElement
            .queryAll(By.css('.tick-tock-time'));
